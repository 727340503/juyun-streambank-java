...
public class WeiChatPayConfig {
	//这个就是自己要保管好的私有Key了（切记只能放在自己的后台代码里，不能放在任何可能被看到源代码的客户端程序中）
		...
		//微信支付
//		public static final String WEICHAT_PAY_TYPE = "WAP";//H5页面支付方式
		public static final String WEICHAT_PAY_TYPE = "JSAPI";//公众号H5页面支付方式
...
//		public static final String CERTPASSWORD = "";
		...
		//机器IP
		public static final String IP = "119.29.187.161";

		
		
		//以下是几个API的路径：
		//H5支付
		public static final String PAY_WAP_API = "weixin://wap/pay";
		
		//统一下单地址
		public static final String PAY_UNIFIEDORDER_API = "https://api.mch.weixin.qq.com/pay/unifiedorder";
